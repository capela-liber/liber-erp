...
// O caminho de quem cobra: abrir o relatório, ver o cliente, expandir o
...
registry.category("web_tour.tours").add("liber_aged_receivable_tour", {
    url: "/odoo",
    steps: () => [
        ...
        {
            content: "entrar no Aged Receivable",
            trigger:
                '.dropdown-item[data-menu-xmlid="liber_aged_receivable.liber_aged_receivable_menu"]',
            run: "click",
        },
        {
            content: "procurar o cliente do tour, para a linha ser a encenada",
            trigger: ".o_searchview_input",
            run: "edit Livraria do Tour",
        },
        {
            content: "e aceitar a primeira sugestao (buscar por cliente)",
            trigger: ".o_searchview_autocomplete .o-dropdown-item.focus",
            run: "click",
        },
        {
            content: "a lista chega agrupada por canal de venda",
            trigger: ".o_list_view .o_group_header",
        },
        {
            content: "abrir o primeiro canal",
            trigger: ".o_list_view .o_group_header:not(.o_group_open):first",
            run: "click",
        },
        // A tela abre com DOIS niveis -- canal de venda e, dentro dele, grupo
        // economico. Abrir so o primeiro leva a outro cabecalho de grupo, nao
        // a uma linha: e preciso descer os dois. Foi o que quebrou o tour
        // quando o agrupamento padrao passou a ter o canal no topo, em 29/08.
        {
            content: "e, dentro dele, o primeiro grupo economico",
            trigger: ".o_list_view .o_group_header:not(.o_group_open):first",
            run: "click",
        },
        {
